...
<@layout.emailLayout>
    ...
    <p style="margin: 0 0 24px; font-size: 14px; color: #6B7280;">
        Welcome to FinanceFlow! Please verify your email address to get started.
    </p>

    <p style="margin: 0 0 16px; font-size: 14px; color: #192035; line-height: 1.6;">
        Click the button below to verify your email. This link will expire in ${linkExpiration} minutes.
    </p>
